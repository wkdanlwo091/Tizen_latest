...
public:
	...
	bool SetProgram(const std::string& vertexSource,
		...
		void SetNewModel(char* objSource, char* objSource2, char* objSource3,
				char* objSource4, char* objSource5, char* objSource6,
				char* objSource7, char* objSource8, char* objSource9, char* objSource10);

		void SetNewModel(char* objSource, char* objSource2, char* objSource3,char* objSource4,
...
private:// Touch handling funtions
		// Touch handling funtions
			...
			glm::mat4 GetWorldMatrix4(int i) const;
			glm::mat4 GetWorldMatrixRand5(int i) const;
			glm::mat4 GetWorldMatrixRand6(int i) const;
			glm::mat4 GetWorldMatrixRand7(int i) const;
			glm::mat4 GetWorldMatrixRand8(int i) const;
			glm::mat4 GetWorldMatrixRand9(int i) const;
			glm::mat4 GetWorldMatrixRand10(int i) const;
...
public:
	...
	void Collision(float* a_x,float* a_y,float* v_x,float* v_y,float* temp_x, float* temp_y, int i) const;
	int Bollision(float& a_x,float& a_y,float& a_z,float& v_x,float& v_y,float& v_z,float& temp_x, float& temp_y,float& temp_z, int num) const;
